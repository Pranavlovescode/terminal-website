...
<span class="text-kali-purple">JS</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<span class="text-kali-orange">[</span><span class="text-kali-purple">████████████</span><span class="text-kali-gray">████████████████████████████</span><span class="text-kali-gray">]</span>&nbsp;<span class="text-kali-cyan">30%</span>`,
  projects: () => `<span class="text-kali-cyan">🚀 Featured Projects & Applications</span><br/><br/>
${icons.github}<span class="text-kali-green font-bold"> <a class="cursor-pointer" href="https://github.com/Pranavlovescode/TaskHeaven">TaskHeaven</a></span> <span class="text-kali-gray">A comprehensive employee and work management web application designed to streamline organizational workflows.</span>
${icons.github}<span class="text-kali-blue font-bold"> <a class="cursor-pointer" href="https://github.com/Pranavlovescode/SiteSnap">SiteSnap</a></span> <span class="text-kali-gray">An innovative chat application that harmonizes real-time communication with seamless user experience.</span>
${icons.github}<span class="text-kali-yellow font-bold"> <a class="cursor-pointer" href="https://github.com/Pranavlovescode/LocalShare">LocalShare</a></span> <span class="text-kali-gray">A simple, lightweight PHP application for sharing files on a local network without requiring internet access. </span>
${icons.github}<span class="text-kali-purple font-bold"> <a class="cursor-pointer" href="https://github.com/Pranavlovescode/FTP-server">FTP Server</a></span> <span class="text-kali-gray">A minimal FTP (File Transfer Protocol) server & client implementation in C++.</span>
${icons.github}<span class="text-kali-yellow-dark font-bold"> <a class="cursor-pointer" href="https://github.com/Pranavlovescode/terminal-website">Terminal Website</a></span> <span class="text-kali-gray">Interactive terminal-style portfolio showcasing skills and projects in a unique cybersecurity-themed interface.</span>
`,
